...
class _AllNewsState extends State<AllNews> {
 ...
 void initState() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: 
          Text(widget.news+"News",style: TextStyle(color: Colors.redAccent,fontWeight: FontWeight.w500),),
...
class AllNewsSection extends StatelessWidget {
  ...
  AllNewsSection({required this.Image,required this.desc,required this.title,required
   this.url});
